 ...
 * User
 *
 * @ORM\Table(name="user", indexes={@ORM\Index(name="fk_bilan", columns={"id_bilan_financier"})})
 * @ORM\Entity
 */
class User
{
     ...
     * @var float|null
     *
     * @ORM\Column(name="salaire", type="float", precision=10, scale=0, nullable=true, options={"default"="NULL"})
     */
